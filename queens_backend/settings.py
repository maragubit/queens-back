"""
Django settings for queens_backend project.
...
ROOT_URLCONF = 'queens_backend.urls'
...
WSGI_APPLICATION = 'queens_backend.wsgi.application'
...
STATIC_URL = 'static/'
# Ruta absoluta en el sistema donde se recopilarán los archivos estáticos
STATIC_ROOT = BASE_DIR / 'staticfiles'

# Directorios adicionales donde Django buscará archivos estáticos (aparte de los de las apps)
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
